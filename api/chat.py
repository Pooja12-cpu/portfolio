...
def get_response():
    ...
    f_prompt = prompt + user_message + "\nAnswer: "

    inputs = tokenizer(f_prompt, return_tensors="pt")
    response = text_generation_pipeline(f_prompt)
